...
interface CommuteHomePageProps extends RouteComponentProps<selectedTab> {
   commuteStore: CommuteStore
}

@observer
class CommuteHomePage extends Component<CommuteHomePageProps> {
   ...
   @action.bound
   onChangeSelectedCategory = async (selectedTab: string) => {
